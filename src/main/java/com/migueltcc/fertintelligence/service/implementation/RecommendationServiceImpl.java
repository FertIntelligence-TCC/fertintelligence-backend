...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    private RecommendationResponseDto toDto(RecommendationModel model, UserModel authenticatedUser) {
        return RecommendationResponseDto.builder()
                ...
                .fertilizerSourceOption(resolveFertilizerSourceOption(model.getFertilizerSourceOption()))
                .origemAdubos(resolveFertilizerSourceOption(model.getFertilizerSourceOption()))
