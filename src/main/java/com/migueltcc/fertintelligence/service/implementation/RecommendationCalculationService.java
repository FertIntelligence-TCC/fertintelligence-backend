...
return rows;}
    ...
    private List<FormulatedMineralFertilizerModel> selectFormulatedFertilizers(UserModel user, FertilizerSourceOption sourceOption){if(sourceOption==FertilizerSourceOption.PRIVATE) return formulatedMineralFertilizerRepository.findAllByUserOrDefaultCreator(user, Cargo.USUARIO_SUPREMO); if(sourceOption==FertilizerSourceOption.PUBLIC) return formulatedMineralFertilizerRepository.findAllByPublicoTrueOrDefaultCreatorOrderByIdAsc(Cargo.USUARIO_SUPREMO); return dedup(formulatedMineralFertilizerRepository.findAllByUserOrDefaultCreator(user, Cargo.USUARIO_SUPREMO), formulatedMineralFertilizerRepository.findAllByPublicoTrueOrDefaultCreatorOrderByIdAsc(Cargo.USUARIO_SUPREMO), FormulatedMineralFertilizerModel::getId);}
    private List<SimpleMineralFertilizerModel> selectSimpleFertilizers(UserModel user, FertilizerSourceOption sourceOption){if(sourceOption==FertilizerSourceOption.PRIVATE) return simpleMineralFertilizerRepository.findAllByUserOrDefaultCreator(user, Cargo.USUARIO_SUPREMO); if(sourceOption==FertilizerSourceOption.PUBLIC) return simpleMineralFertilizerRepository.findAllByPublicoTrueOrDefaultCreatorOrderByNameAsc(Cargo.USUARIO_SUPREMO); return dedup(simpleMineralFertilizerRepository.findAllByUserOrDefaultCreator(user, Cargo.USUARIO_SUPREMO),simpleMineralFertilizerRepository.findAllByPublicoTrueOrDefaultCreatorOrderByNameAsc(Cargo.USUARIO_SUPREMO),SimpleMineralFertilizerModel::getId);}    
