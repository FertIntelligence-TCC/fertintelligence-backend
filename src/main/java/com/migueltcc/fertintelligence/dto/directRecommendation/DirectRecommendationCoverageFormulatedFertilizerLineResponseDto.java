...
@NoArgsConstructor
@AllArgsConstructor
public class DirectRecommendationCoverageFormulatedFertilizerLineResponseDto {
    ...
    @JsonProperty("n_recomendado_kg_ha")
    private Double requiredN;

    @JsonProperty("p2o5_recomendado_kg_ha")
    private Double requiredP2O5;

    @JsonProperty("k2o_recomendado_kg_ha")
