...
@AllArgsConstructor
@Builder
public class PropertyAccessRequestResponseDto {

    @Schema(description = "ID único da solicitação", example = "150")
    @JsonProperty("id")
    private Long id;
    ...
    @Schema(description = "Cargo do solicitante", example = "AGRONOMO")
