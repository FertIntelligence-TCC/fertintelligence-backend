...
public class PhysicalAnalysisExtractControllerImpl implements PhysicalAnalysisExtractController {
    ...
    // NOVO MÉTODO: Busca todas as análises do talhão (Permissão de Leitura)
    @Override
    ...
    public ResponseEntity<List<PhysicalAnalysisExtractResponseDto>> getPhysicalAnalysisExtractsByPlot(
            ...
            Authentication authentication) {
        List<PhysicalAnalysisExtractResponseDto> extracts = physicalAnalysisExtractService.getAllByPlotId(
                plotId,
                authentication.getName()
        );
