...
public interface OrganoMineralFertilizerRepository extends JpaRepository<OrganoMineralFertilizerModel, Long> {
    List<OrganoMineralFertilizerModel> findAllByUserAndPublicoFalseOrderByNameAsc(UserModel user);

    List<OrganoMineralFertilizerModel> findAllByUser(UserModel user);

    List<OrganoMineralFertilizerModel> findAllByUserOrderByNameAsc(UserModel user);

    @Query("select f from OrganoMineralFertilizerModel f where f.user.username = :username order by f.name asc")
    List<OrganoMineralFertilizerModel> findAllByUserUsernameOrderByNameAsc(@Param("username") String username);
    ...
    List<OrganoMineralFertilizerModel> findAllByPublicoTrueAndUser_CargoNotOrderByNameAsc(Cargo cargo);
