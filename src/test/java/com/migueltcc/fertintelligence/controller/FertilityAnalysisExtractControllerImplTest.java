...
public class FertilityAnalysisExtractControllerImplTest extends AbstractControllerTest {
    ...
    private FertilityAnalysisExtractCreateRequestDto createCreateRequestDto() {
        return FertilityAnalysisExtractCreateRequestDto.builder()
                ...
                .potassio(3.5)
                .unidadePotassio(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .sodio(2.4)
                .unidadeSodio(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .aluminio(0.5)
                .unidadeAluminio(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .aluminioMaisHidrogenio(4.2)
                .unidadeAluminioMaisHidrogenio(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .somaBases(60.0)
                .unidadeSomaBases(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .ctcEfetiva(70.0)
                .unidadeCtcEfetiva(FertilityAnalysisUnit.CMOLC_PER_DM3)
                .ctcPh7(80.0)
                .unidadeCtcPh7(FertilityAnalysisUnit.CMOLC_PER_DM3)
    ...
    private FertilityAnalysisExtractModel createFertilityAnalysisExtractModel(Long id,
        ...
        return FertilityAnalysisExtractModel.builder()
                ...
                .potassio(3.5)
                .unidadePotassio(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .sodio(2.4)
                .unidadeSodio(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .aluminio(0.5)
                .unidadeAluminio(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .aluminioMaisHidrogenio(4.2)
                .unidadeAluminioMaisHidrogenio(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .somaBases(60.0)
                .unidadeSomaBases(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .ctcEfetiva(70.0)
                .unidadeCtcEfetiva(FertilityAnalysisUnit.MMOLC_PER_DM3)
                .ctcPh7(80.0)
    ...
    void createFertilityAnalysisExtractWithRangeSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/fertility-analysis-extract/register")
                ...
                .andExpect(jsonPath("$.unidade_magnesio").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_potassio").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_sodio").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_aluminio").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_aluminio_mais_hidrogenio").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_soma_bases").value("mmolc/dm³"))
                .andExpect(jsonPath("$.unidade_ctc_efetiva").value("mmolc/dm³"))
