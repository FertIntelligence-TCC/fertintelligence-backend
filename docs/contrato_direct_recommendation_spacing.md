...
Os campos textuais legados `laudo_tecnico` e `conteudo` continuam em Markdown. Nas tabelas geradas pelo backend, apenas a coluna aplicavel recebe valor calculado quando houver dados; a outra permanece como `Nao aplicavel`.
